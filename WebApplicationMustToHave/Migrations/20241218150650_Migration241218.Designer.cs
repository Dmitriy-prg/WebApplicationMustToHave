...
namespace WebApplicationMustToHave.Migrations
{
    ...
    [Migration("20241218150650_Migration241218")]
    partial class Migration241218
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("WebApplicationMustToHave.DataModels.DbComposition", b =>
                {
                    ...
                    b.HasIndex("DbBookBinderId")
                        .IsUnique()
                        .HasFilter("[DbBookBinderId] IS NOT NULL");
            ...
            modelBuilder.Entity("WebApplicationMustToHave.DataModels.DbComposition", b =>
                {
                    ...
                    b.HasOne("WebApplicationMustToHave.DataModels.DbBookBinder", "Binder")
                        .WithOne()
                        .HasForeignKey("WebApplicationMustToHave.DataModels.DbComposition", "DbBookBinderId");
